  ...
  function GameFactory($http, $q, $localStorage) {
    ...
    function getUserCollection(username) {
      if ($localStorage.collection){
        ...
        return $http({
          method: 'GET',
          url: 'https://gametableproxy.herokuapp.com/api/v1/collection?username=' + username + '&stats=1&excludesubtype=boardgameexpansion&own=1',
    ...
    function searchForGame(title) {
      ...
      return $http({
        method: 'GET',
        url: 'https://gametableproxy.herokuapp.com/api/v1/search?query=' + cleanTitle,
        ...
        return $http({
          method: 'GET',
          url: 'https://gametableproxy.herokuapp.com/api/v1/thing?id=' + listOfIds + '&stats=1',
